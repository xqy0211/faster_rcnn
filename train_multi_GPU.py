...
def main(args):
    ...
    # check voc root
    if os.path.exists(os.path.join(VOC_root, "DAGM_DATASET")) is False:
        raise FileNotFoundError("DAGM_DATASET dose not in path:'{}'.".format(VOC_root))

    # load train data set
    train_data_set = DAGMDataSet(VOC_root, data_transform["train"], True)

    # load validation data set
    val_data_set = DAGMDataSet(VOC_root, data_transform["val"], False)
