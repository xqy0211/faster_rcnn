...
class TGKDataSet(Dataset):
    def __init__(self, camera_root, transforms, train_set=True):
        self.root = os.path.join(camera_root, "TGK_DATASET")
        ...
        # read class_indict
        try:
            json_file = open('./tgk_classes.json', 'r')
...
#
# # load train data set
# train_data_set = PCBDataSet(os.getcwd(), data_transform["train"], True)
